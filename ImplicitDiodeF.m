...
for V = vdata
    ...
    fout(i) = fsolve(@(I) (params(1) * (exp((V - I*params(3))/(params(2)*Vth))-1) + ((V - I*params(3))/params(4)) - I), 0.1,optimset('display','off','tolfun',1e-7));
    ...
    %fout(i) = fsolve(@(I) (params(1) * exp((V - I*params(3))/(params(2)*Vth)) + params(5) * exp((V - I*params(3))/(params(6)*Vth)) + ((V - I*params(3))/params(4)) - I), 0.1,optimset('display','off'));
